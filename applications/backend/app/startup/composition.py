...
class Composition:
    ...
    def wire(self, *, registry_manager: Any, databases: Any) -> None:
        ...
        from app.adapters.persistence.provider_wallet_sql_adapter import (
            ProviderWalletSqlAdapter,
        )
        ...
        from app.adapters.persistence.provider_business_customers_sql_adapter import (
            ProviderBusinessCustomersSqlAdapter,
        )
        ...
        from app.adapters.persistence.provider_promotions_sql_adapter import (
            ProviderPromotionsSqlAdapter,
        )

        self.provider_promotions_repository = ProviderPromotionsSqlAdapter(
            self.sql_query_manager
        )

        from app.adapters.persistence.provider_analytics_sql_adapter import (
            ProviderAnalyticsSqlAdapter,
        )
        ...
        from app.adapters.persistence.provider_account_restrictions_sql_adapter import (
            ProviderAccountRestrictionsSqlAdapter,
        )
    ...
    def provider_wallet_service(self) -> Any:
        """ProviderWalletService — provider wallet (Req Phase 29)."""
    ...
    def provider_ranking_service(self) -> Any:
        """ProviderRankingService — ranking & reputation (Req Phase 35)."""
    ...
    def provider_business_customers_service(self) -> Any:
        """ProviderBusinessCustomersService — negotiated-rate customers (Req Phase 43)."""
        from app.domains.providers.services.provider_business_customers_service import (
            ProviderBusinessCustomersService,
        )
    ...
    def provider_promotions_service(self) -> Any:
        """ProviderPromotionsService — provider promotion codes (Req Phase 48)."""
        from app.domains.providers.services.provider_promotions_service import (
            ProviderPromotionsService,
        )

        return ProviderPromotionsService(repository=self.provider_promotions_repository)

    def provider_analytics_service(self) -> Any:
        """ProviderAnalyticsService — monthly trend overview (Req Phase 49)."""
        from app.domains.providers.services.provider_analytics_service import (
    ...
    def provider_account_restrictions_service(self) -> Any:
        """ProviderAccountRestrictionsService — account restrictions & status (Req Phase 53)."""
        from app.domains.providers.services.provider_account_restrictions_service import (
            ProviderAccountRestrictionsService,
        )

...
from app.domains.providers.api.account_restrictions_router import (
    router as provider_account_restrictions_router,
)
...
from app.domains.providers.api.job_assignments_router import (
    router as provider_job_assignments_router,
)
...
api_v1_router.include_router(provider_job_assignments_router)
...
api_v1_router.include_router(provider_account_restrictions_router)

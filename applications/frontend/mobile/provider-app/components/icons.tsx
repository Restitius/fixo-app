...
export function TruckIcon({ size = 24, color = '#0B111F' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Rect x={2} y={7} width={12} height={9} rx={1.5} stroke={color} strokeWidth={1.7} />
      <Path d="M14 10h4l3 3.5V16h-7" stroke={color} strokeWidth={1.7} strokeLinejoin="round" />
      <Circle cx={7} cy={18} r={2} stroke={color} strokeWidth={1.7} />
      <Circle cx={17.5} cy={18} r={2} stroke={color} strokeWidth={1.7} />
    </Svg>
  )
}

export function ToolIcon({ size = 24, color = '#0B111F' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        d="M14.7 6.3a4 4 0 0 0-5.4 5l-6 6 2.4 2.4 6-6a4 4 0 0 0 5-5.4l-2.3 2.3-2-2 2.3-2.3Z"
        stroke={color}
        strokeWidth={1.6}
        strokeLinejoin="round"
        strokeLinecap="round"
...
export function ClipboardCheckIcon({ size = 24, color = '#0B111F' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Rect x={5} y={4.5} width={14} height={17} rx={2} stroke={color} strokeWidth={1.7} />
      <Rect x={9} y={2.5} width={6} height={3.5} rx={1} stroke={color} strokeWidth={1.7} />
      <Path d="M8.5 13l2.3 2.3L15.5 11" stroke={color} strokeWidth={1.7} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  )
}

export function BriefcaseIcon({ size = 24, color = '#0B111F' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Rect x={2.5} y={7.5} width={19} height={12.5} rx={2.5} stroke={color} strokeWidth={1.7} />
      <Path d="M8 7.5V5.5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" stroke={color} strokeWidth={1.7} strokeLinejoin="round" />
      <Path d="M2.5 13h19" stroke={color} strokeWidth={1.7} />
    </Svg>
  )
}

export function SettingsIcon({ size = 24, color = '#0B111F' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Circle cx={12} cy={12} r={3} stroke={color} strokeWidth={1.7} />
      <Path
        d="M19.4 13.5a1.7 1.7 0 0 0 .34 1.87l.06.06a2.05 2.05 0 1 1-2.9 2.9l-.06-.06a1.7 1.7 0 0 0-1.87-.34 1.7 1.7 0 0 0-1 1.55V19.6a2.05 2.05 0 1 1-4.1 0v-.09a1.7 1.7 0 0 0-1.1-1.55 1.7 1.7 0 0 0-1.87.34l-.06.06a2.05 2.05 0 1 1-2.9-2.9l.06-.06a1.7 1.7 0 0 0 .34-1.87 1.7 1.7 0 0 0-1.55-1H4.4a2.05 2.05 0 1 1 0-4.1h.09a1.7 1.7 0 0 0 1.55-1.1 1.7 1.7 0 0 0-.34-1.87l-.06-.06a2.05 2.05 0 1 1 2.9-2.9l.06.06a1.7 1.7 0 0 0 1.87.34h.08a1.7 1.7 0 0 0 1-1.55V4.4a2.05 2.05 0 1 1 4.1 0v.09a1.7 1.7 0 0 0 1 1.55h.08a1.7 1.7 0 0 0 1.87-.34l.06-.06a2.05 2.05 0 1 1 2.9 2.9l-.06.06a1.7 1.7 0 0 0-.34 1.87v.08a1.7 1.7 0 0 0 1.55 1H19.6a2.05 2.05 0 1 1 0 4.1h-.09a1.7 1.7 0 0 0-1.55 1Z"
        stroke={color}
        strokeWidth={1.4}
        strokeLinejoin="round"
      />

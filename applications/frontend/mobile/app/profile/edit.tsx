    ...
    <SafeAreaView className="flex-1 bg-white" edges={['top']}>
      ...
      <View className="flex-1 px-6 pt-2">
        ...
        <View className="flex-col gap-4 mt-7">
          <TextField icon={<EditIcon size={20} color="#6C7585" />} placeholder="Full Name" value={fullName} onChangeText={setFullName} />
          <TextField icon={<PhoneIcon size={20} color="#6C7585" />} placeholder="Phone Number" keyboardType="phone-pad" value={phone} onChangeText={setPhone} />
        ...
        <Text className="text-[12px] text-muted text-center mt-3">Email can't be changed from the app.</Text>

        <View className="flex-1" />

        <View className="pb-10 pt-6">
          <Button onPress={save} loading={loading} disabled={!dirty}>Save Changes</Button>
        </View>
      </View>
    </SafeAreaView>
  )

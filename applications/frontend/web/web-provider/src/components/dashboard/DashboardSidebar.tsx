...
const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Job Assignments", icon: UserCog, to: "/job-assignments" },
      { title: "Equipment", icon: HardHat, to: "/equipment" },
    ],
  },
  {
    label: "Money",
    items: [
      ...
      { title: "Promotions", icon: Percent, to: "/promotions" },
      { title: "Subscription", icon: Crown, to: "/subscription" },
    ],
  },
  {
    label: "Reputation",
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Safety", icon: ShieldAlert, to: "/safety" },
